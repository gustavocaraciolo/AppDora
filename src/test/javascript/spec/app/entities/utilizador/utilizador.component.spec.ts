...
import { UtilizadorComponent } from 'app/entities/utilizador/utilizador.component';
...
describe('Component Tests', () => {
  describe('Utilizador Management Component', () => {
    let comp: UtilizadorComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UtilizadorComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.utilizadors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
